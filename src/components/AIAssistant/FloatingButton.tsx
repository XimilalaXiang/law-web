...
const FloatingButton: React.FC<FloatingButtonProps> = ({ onClick, hasUnread = false }) => {
  return (
    ...
    >
      ...
      {/* 主按钮 - Neumorphic风格 */}
      <div className="relative w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full shadow-[8px_8px_20px_rgba(59,130,246,0.3),-4px_-4px_15px_rgba(147,197,253,0.2)] flex items-center justify-center transition-all duration-300 group-hover:shadow-[6px_6px_15px_rgba(59,130,246,0.4),-3px_-3px_10px_rgba(147,197,253,0.3)] group-hover:scale-105 group-active:scale-95 border border-blue-400/30">
